...
<div class="cover">
    <h1>박민이</h1>
    <p class="subtitle">AI 기반 운영 기획 포트폴리오</p>
    <p class="desc">모빌리티 서비스 런칭부터 약 5년간, 현장의 문제를 데이터로 정의하고 AI/ML로 해결해온 운영 기획자</p>
...
<div style="margin-top: 30px;">
    <div class="competency-box">
        ...
        <div class="desc">LightGBM 앙상블 모델로 일별 수요를 예측하고 MAPE 11% 달성</div>
    </div>
    <div class="competency-box">
...
<table>
    ...
    <tbody>
        <tr><td>1</td><td>ML 기반 수요 예측</td><td>2-Model Ensemble 일별 수요 예측</td><td>LightGBM / BigQuery</td><td>MAPE 11.1%, 일일 자동화</td></tr>
...
<div class="project-page">
    ...
    <h3>Results</h3>
    <ul>
        <li><strong>MAPE 11.1%</strong> 달성 (7일 이동평균 기준, 범위 3.7%~16.4%)</li>
...
<div class="project-page">
    ...
    <p><strong>[월간 자산 리포트]</strong> 매월 1일 GitHub Actions 자동 실행 → BigQuery bike_snapshot 월평균 집계 → Slack Block Kit 자동 발송</p>
...
<div class="project-page">
    ...
    <ul>
        ...
        <li>EC2에서 돌아가는 Inspector(billing_stack, bike_snapshot 등)가 죽어도 <strong>알 수 없음</strong></li>

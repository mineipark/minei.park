...
<div class="competency-grid">
    <div class="comp-card">
        ...
        <div class="value">ML 수요 예측 모델로<br>재배치·인력 스케줄링<br><strong>의사결정 근거 설계</strong></div>
    </div>
    <div class="comp-card">
        <div class="label">Analysis</div>
        <div class="value">DiD·ROI 등 인과추론으로<br>현장 작업 효과를<br><strong>정량적으로 검증</strong></div>
    </div>
    <div class="comp-card">
        <div class="label">AX</div>
        <div class="value"><strong>19개 자동화</strong> 도구와<br>6-Layer 파이프라인 감시로<br>수동 운영을 시스템화</div>
    </div>
</div>
...
<table>
    ...
    <tbody>
        ...
        <tr><td>5</td><td>운영 대시보드</td><td>7페이지 멀티페이지 모니터링</td><td>Streamlit / Folium</td><td>RBAC, GPS 동선 시각화</td></tr>
        <tr><td>6</td><td>Data 파이프라인 모니터링</td><td>6-Layer 파이프라인 감시 시스템</td><td>BigQuery / Slack / EC2</td><td>387 테이블 자동 감시</td></tr>
    </tbody>
</table>
